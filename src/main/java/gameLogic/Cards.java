...
public class Cards {
  ...
  public static String getCards() {
    String[] playingCards = new String[]{"6 Bonusnote bei A’Campo",
        ...
        "-2 Dein Code läuft nicht. Gehe 2 Felder zurück.",
        "-2 Jemand schickt dir die falschen Lösungen der dieswöchigen Matheaufgaben in den Chat" + "§" + "und du schreibst sie ab. Gehe 2 Felder zurück.",
        ...
        "-10 Du erfährst 10 Stunden vor der Abgabe, " + "§" + "dass du javazoom nicht benutzen darfst.",
    ...
    // Ereigniskarten mit Bonuswürfel oder Tausch erstellen.
